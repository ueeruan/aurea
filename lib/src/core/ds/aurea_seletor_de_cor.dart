...
import '../../features/editor/domain/codigo_de_cor.dart';
...
/// SELETOR DE COR DO DESIGN SYSTEM — qualquer cor, nao uma paleta fixa.
///
/// E o UNICO seletor do app: toda linha de cor ([AureaPropertyRow.cor]),
/// o desenho livre e os paineis abrem este. Veio de
/// `am/color_picker_sheet.dart` quando a UI antiga foi apagada; a folha
/// agora tem o fundo, o raio e o movimento das folhas do DS.
///
///
...
Future<Color?> showColorPicker(
  ...
  return showModalBottomSheet<Color>(
    ...
    enableDrag: false,
    barrierColor: AureaCores.palco.withValues(alpha: .35),
