...
/// A CAIXA DO PALCO: o `RepaintBoundary` em volta do `PreviewStage` do
/// editor. O conta-gotas fotografa por ela, e a miniatura do projeto
/// (`ThumbnailService.capture`) tambem. Mora aqui, e nao na casca, porque
/// o seletor de cor do DS precisa dela e o DS nao depende do editor.
