...
sealed class Layer {
  Layer({
    ...
    this.matteSourceId,
       ...
       pivotZ = pivotZ ?? AnimatedDouble(0),
  ...
  /// A ANCORA EM Z: a que distancia, em profundidade, fica o ponto em
  /// torno do qual a camada gira.
  ///
  /// O ponto de ancoragem era so X e Y, entao uma camada 3D girava
  /// sempre em torno do proprio plano. Com Z ela orbita um ponto a
  /// frente ou atras — e a conta do carrossel de cartoes, do anel de
  /// logos e da capa que abre como porta. Zero e o comportamento de
  /// sempre, e projeto antigo nem grava a chave.
  final AnimatedDouble pivotZ;

  /// A ORIENTACAO (X, Y, Z), separada da rotacao — como no After
  /// Effects.
  ///
  /// A rotacao ACUMULA voltas: e o que se anima quando algo gira. A
  /// orientacao e POSE: onde a camada esta virada, sem contar quantas
  /// voltas deu. Tinhamos so a rotacao, entao nao dava para deixar uma
  /// camada de lado e girar em cima disso sem misturar as duas coisas
  /// num keyframe so.
  ///
  /// Entra ANTES das rotacoes, como la. Zero e o que sempre foi, e
  /// projeto antigo nem grava as chaves.
...
class GroupLayer extends Layer {
  ...
  /// novo, e o matte que apontava para um irmao passa a apontar para a
  /// copia dele. Sem isso o recorte da copia sumia (o alvo ia a alfa zero
  /// e a fonte aparecia).
  @override
