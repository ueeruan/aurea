import '../../editor/domain/temporal_interpolation.dart';
export '../../editor/domain/temporal_interpolation.dart'
    show fatorDeInterpolacao, velocidadeMaisLenta, filtroDeInterpolacao;
