...
EffectType.lightSweep => 'Varredura de luz: um facho reto atravessa a camada e soma luz. Saiu da galeria a pedido do dono.',
  ...
  EffectType.posterizeTime => 'Faz a CAMADA andar em degraus de N quadros por segundo: 12 para o visual de anime, 8 para stop motion, 4 para travado. A camada segura cada quadro até o próximo degrau, e o tempo quantizado vale para tudo o que ela tem — o vídeo, os keyframes, a transformação e os efeitos. O FPS da composição não muda.',
  ...
  EffectType.twitch => 'Twitch da tiques rapidos na imagem em momentos aleatorios: desfoque, flash de luz, zoom, deslize com borrao de movimento e separacao RGB, e tinta de cor. Cada operador liga e desliga sozinho e tem sua quantidade e intervalo; Intensidade e Velocidade gerais mandam em todos.',
  ...
  EffectType.tremor => 'S_Shake treme a camada como uma câmera na mão: a imagem anda em X e Y, aproxima e afasta (Z) e inclina, com um tremor aleatório mas repetível (a mesma Semente dá sempre o mesmo movimento) e uma onda regular opcional. Amplitude e Frequência controlam o tamanho e a rapidez; o Estilo Tremido alterna quietude e trancos, e Saltos pula de um lugar a outro com deriva lenta. As bordas que aparecem podem ser repetidas ou espelhadas, o borrão de movimento suaviza os trancos e as amplitudes por canal separam o vermelho, o verde e o azul. S_DissolveShake usa o mesmo tremor como transição: anime Dissolver de 0 a 100 e a camada treme cada vez mais até sumir (ou surge tremendo e assenta, na direção Surgir).',
  ...
  EffectType.ccLens => 'CC Lens: uma lente redonda sobre a camada. Tamanho é o raio do disco; Convergência positiva amplia o centro como lupa e negativa encolhe a imagem para dentro. Fora do disco a camada fica transparente, como no After Effects.',
  EffectType.opticsCompensation => 'Compensação de ótica: curva a imagem como uma lente grande-angular. Campo de visão maior curva mais e abre as bordas; Inverter distorção faz o contrário e corrige uma imagem já curvada.',
  EffectType.dissolveShake => 'S_DissolveShake: transição que dissolve a camada enquanto ela treme cada vez mais. Anime o percentual de 0 a 100 para a camada sumir tremendo.',
  EffectType.chromaKeyPro => 'Chroma Key: recorta a tela verde ou azul. Escolha a Cor da tela com o conta-gotas; Ganho recorta mais, Clip preto e Clip branco limpam o matte, Remover derramamento tira o verde da borda e da pele, Estreitar e Suavizar borda acertam o contorno. Ver Matte mostra o recorte em preto e branco.',
  EffectType.sRays => 'S_Rays: raios de luz que saem das partes claras da camada em direção ao Centro. Limiar escolhe o que acende; Comprimento e Decaimento controlam o alcance.',
  EffectType.deepGlow => 'Deep Glow: brilho de queda longa, que parece luz de verdade. Raio define o alcance; Exposição a força; Limiar deixa só as partes claras acenderem; Tingimento colore o brilho.',
  EffectType.brilho => 'Brilho: glow clássico ao redor das partes claras. Raio, Intensidade e Limiar controlam tamanho, força e o que acende.',
  EffectType.sSpotLight => 'S_SpotLight: um holofote elíptico. Posicione pelo Centro, ajuste Largura, Altura e Rotação; Brilho ilumina dentro e Fundo escurece fora.',
  EffectType.sGlint => 'S_Glint: estrelas de luz nos pontos mais claros. Braços define 2, 4, 6 ou 8 raios; Comprimento, Rotação e Decaimento dão a forma.',
  EffectType.sGlintRainbow => 'S_GlintRainbow: como o S_Glint, com os braços em arco-íris. Espalhar cores repete o espectro ao longo do braço; Deslocar matiz gira as cores.',
  EffectType.sGlowRings => 'S_GlowRings: anéis de luz em volta dos pontos claros, com um halo curto. Raio dos anéis, Anéis e Espessura desenham os círculos.',
  EffectType.sGlowAura => 'S_GlowAura: faixas de cor psicodélicas que seguem o brilho da imagem. Frequência é quantas voltas o espectro dá; Fase anima as faixas; as fases de vermelho, verde e azul mudam as cores.',
  EffectType.sGlowDarks => 'S_GlowDarks: um brilho escuro — as áreas escuras se espalham e escurecem em volta. Limiar escolhe o que conta como escuro; Largura, até onde a sombra vai.',
  EffectType.sEdgeRays => 'S_EdgeRays: raios que nascem das bordas da imagem e correm para o Centro. Limiar da borda escolhe que contornos acendem.',
  EffectType.crossGlitch => 'Cross Glitch cria surtos de falha digital em intervalos: blocos trocados com padrao colorido, faixas de linhas deslocadas e perdidas, chacoalhar com separacao RGB e cintilacao de brilho e saturacao. Intervalo e Duracao definem quando cada surto aparece e quanto dura.',
  ...
  EffectType.autoPaint => 'S_AutoPaint transforma a imagem numa pintura a pinceladas: cada pincelada pega a cor da imagem no seu centro e segue as bordas (Van Gogh), cruza as bordas (Hairy Paint) ou vira uma celula pontuda sem direcao (Pointalize). Frequencia controla quantas pinceladas cabem no quadro (mais = menores), Comprimento do traco estica cada uma, Alinhar traços deixa as vizinhas mais paralelas e Suavizar cores aproxima as cores de pinceladas proximas. Nitidez realca as bordas da pintura pronta, com a largura relativa ao tamanho do traço. Semente troca o sorteio das pinceladas; Re-sortear a cada N quadros faz a pintura "ferver" no video.',
  EffectType.tvDamage => 'O S_TVDamage imita uma TV analógica com defeito: chuvisco colorido, pontos de interferência, fantasmas deslocados da imagem, ondulação e rolagem de sincronismo com a borda preta aparecendo, barras de zumbido subindo pela tela, listras de cor, linhas de varredura e resolução reduzida. A Recepção geral controla tudo o que vem do sinal de uma vez; Avanço rápido, Falhas de fita, Vinheta, Orthicon, Olho de peixe e Desligar acrescentam defeitos de videocassete e do aparelho.',
  EffectType.vhsDamage => 'O S_VHSDamage imita uma fita VHS gasta: a cor perde resolução e escorre para o lado, a luma fica levemente borrada na vertical, a imagem treme com o ruído da fita, aparecem linhas de varredura e faixas de riscos e faíscas brancas e pretas que mudam a cada quadro. Ligue ou desligue cada estágio (estilo de cor, redução de cor, aberração, florescer, luma, ruído de fita, avanço rápido, linhas, riscos e faíscas) e use Misturar com original para dosar o efeito.',
  ...
  EffectType.pixelSort => 'S_PixelSort arrasta e ordena os pixels ao longo de linhas, criando faixas esticadas de glitch. So entram na ordenacao os trechos acima (ou abaixo) do Limiar, medidos pelo Tipo de ordenacao (monocromatico, media, canal, matiz, saturacao, brilho). No modo Linear as linhas sao paralelas no Angulo escolhido; no Radial saem de um centro como raios; no Circular giram em circulos concentricos. Reiniciar ao acaso quebra as faixas em pedacos menores, Suavizar mascara deixa a ordenacao atravessar detalhes escuros finos e Inverter ordem troca claro e escuro de lado. Use Mostrar para ver a mascara do limiar e os pontos de reinicio enquanto ajusta.',
