...
namespace thermion
{
    extern "C"
    {
        ...
        EMSCRIPTEN_KEEPALIVE void Aurea_configureDynamicResolutionRenderThread(
            TView *view, TRenderer *renderer, bool enabled, float minimumScale,
            uint32_t requestId, VoidCallback onComplete);
        EMSCRIPTEN_KEEPALIVE void Aurea_getResolutionScaleRenderThread(TView *view, void (*onComplete)(float));
        EMSCRIPTEN_KEEPALIVE void Aurea_getGpuDurationRenderThread(TRenderer *renderer, void (*onComplete)(float));
        EMSCRIPTEN_KEEPALIVE void Aurea_renderPreviewFrameRenderThread(
            TRenderer *renderer, TView *view, TSwapChain *swapChain, void (*onComplete)(bool));
