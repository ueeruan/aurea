...
void main() {
  ...
  // O GRUPO "Ficha do Deep Glow" SAIU DAQUI: ele media os padroes
  // da ficha de `EffectType.glowVol`, que nao esta no catalogo oficial (o
  // tipo so sobreviveu em `effectParamAliases`, para ler projeto antigo).
  // A matematica de bloom abaixo continua viva e e ela que este arquivo
  // protege.
