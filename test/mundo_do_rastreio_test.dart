// O MUNDO DO RASTREIO nas maos da pessoa: origem, escala real e o
// rastreio como ATIVO do trecho (cortar e duplicar nao o perdem).
//
// A prova central de origem/escala e a INVARIANCIA: mover ou escalar o
// mundo inteiro nao pode mudar um pixel da reprojecao — se mudou, a
// transformacao nao foi de semelhanca e o objeto colado escorregaria.
