...
/// RENDER DE MESA da COLINA: os quadros do modelo, pintados pelo mesmo
...
void main() {
  testWidgets('renderiza a Colina em quadros', (tester) async {
    ...
    final outDir = Directory('build/render/colina');
