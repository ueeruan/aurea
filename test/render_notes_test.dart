...
///
///   AUREA_RENDER=1 flutter test test/render_notes_test.dart
///
/// Os quadros saem em build/render/notes/fNNNN.png; o ffmpeg monta o
/// video.
void main() {
  testWidgets('renderiza o modelo Notes em quadros', (tester) async {
    ...
    final project = buildNotesMotionTemplate();
    ...
    final outDir = Directory('build/render/notes');
