...
void main() {
  group('Correcao 10.1.1 — contagens obrigatorias', () {
    ...
    test('so dois menus escondidos no aplicativo, e os dois com estado', () {
      ...
      // O ESTUDIO 3D TINHA O TERCEIRO (a barra "Cena | Camera | menu" da
      // missao de 2026-09-07) e ele SAIU com o motor: nao ha mais estudio,
      // e com ele foram embora os modos que aquele menu escondia
      // (avancado, grade, auto-key). A regra fica valendo — e agora com
      // menos um lugar onde ela poderia ser quebrada.
      final culpados = <String>[];
      for (final f in _fontes()) {
        final codigo = _semComentarios(f);
        if (codigo.contains('CupertinoSlider(') ||
    ...
    test('so dois menus escondidos no aplicativo, e os dois com estado', () {
      ...
      // O ESTUDIO 3D TINHA O TERCEIRO (a barra "Cena | Camera | menu" da
      // missao de 2026-09-07) e ele SAIU com o motor, em 18/09: nao ha
      // mais estudio, e com ele foram embora os modos que aquele menu
      // escondia (avancado, grade, auto-key). A regra fica valendo — e
      // agora com um lugar menos onde ela poderia ser quebrada.
      final culpados = <String>[];
      for (final f in _fontes()) {
